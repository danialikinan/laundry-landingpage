...
<head>
  ...
  <link rel="shortcut icon" href="{!! asset('assets/css/Logo 1.svg') !!}" type="">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="about">Tentang Kami <span class="sr-only">(current)</span> </a>
                </li>
                <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Layanan ideal untuk pakaian anda. Nikmati layanan laundry yang aman dari kerusakan, tertukar atau hilang dan hemat waktu.
